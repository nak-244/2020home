                                        ...
                                        if (!empty($sector_skills)) {
                                            ...
                                            <ul class="suggested-skills suggested-skills-sector-<?php echo ($candidate_sector) ?>">
                                                ...
                                                foreach ($sector_skills as $sector_skill_sid) {
                                                    ...
                                                    ?>
                                                    <li class="skills-cloud" onclick="jQuery('#cand-skills').tagit('createTag', '<?php echo ($skill_term_obj->name) ?>'); return false;"><?php echo ($skill_term_obj->name) ?></li>
                                                    <?php
                                            ...
                                            <ul class="suggested-skills">
                                                ...
                                                foreach ($skills_terms as $skill_term) {
                                                    ?>
                                                    <li class="skills-cloud" onclick="jQuery('#cand-skills').tagit('createTag', '<?php echo($skill_term->name) ?>'); return false;"><?php echo($skill_term->name) ?></li>
                                                    <?php
                                                }
                                                ?>
                                            </ul>
                                            ...
                                            <li class="jobsearch-column-12 resume-list-item resume-list-edu">
                                                ...
                                                <div class="jobsearch-add-popup jobsearch-update-resume-items-sec">
                                                    ...
                                                    <ul class="jobsearch-row jobsearch-employer-profile-form">
                                                        ...
                                                        <li class="jobsearch-column-12">
                                                            <label><?php esc_html_e('Description', 'wp-jobsearch') ?></label>
                                                            <textarea name="jobsearch_field_education_description[]" <?php echo apply_filters('jobsearch_candash_resume_edudesc_atts', ''); ?>><?php echo ($exfield_val) ?></textarea>
                                                        </li>
                                                        <li class="jobsearch-column-12">
                            ...
                            <div class="jobsearch-add-popup jobsearch-add-resume-item-popup">
                                ...
                                <ul class="jobsearch-row jobsearch-employer-profile-form">
                                    ...
                                    <li class="jobsearch-column-12">
                                        ...
                                        ?>
                                        <textarea id="add-expr-desc" <?php echo apply_filters('jobsearch_candash_resume_expdesc_atts', '') ?>></textarea>
                                    </li>
                                    <li class="jobsearch-column-12">
                                                ...
                                                <div class="jobsearch-add-popup jobsearch-update-resume-items-sec">
                                                    ...
                                                    <ul class="jobsearch-row jobsearch-employer-profile-form">
                                                        ...
                                                        <li class="jobsearch-column-12">
                                                            ...
                                                            echo apply_filters('jobsearch_candash_resume_expdesc_label', $title_html);
                                                            ?>
                                                            <textarea name="jobsearch_field_experience_description[]" <?php echo apply_filters('jobsearch_candash_resume_expdesc_atts', '') ?>><?php echo ($exfield_val) ?></textarea>
                                                        </li>
                                                        <li class="jobsearch-column-12">
                                                            <input class="update-resume-list-btn" type="submit" value="<?php esc_html_e('Update', 'wp-jobsearch') ?>">
                                                        </li>
                        ...
                        <div class="jobsearch-candidate-resume-wrap">
                            ...
                            <div class="jobsearch-add-popup jobsearch-add-resume-item-popup">
                                ...
                                <ul class="jobsearch-row jobsearch-employer-profile-form">
                                    ...
                                    <li class="jobsearch-column-12">
                                        <input type="submit" id="add-resume-skills-btn" value="<?php esc_html_e('Add Expertise', 'wp-jobsearch') ?>">
                            ...
                            ?>
                            <div id="jobsearch-resume-skills-con" class="<?php echo apply_filters('jobsearch_canddash_resume_skillist_mainclass', 'jobsearch-add-skills') ?>">
                                <ul class="jobsearch-row">
                                    <?php
