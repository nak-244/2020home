    ...
    if (isset($_POST)) {
        if ($post_type == 'employer') {
            ...
            if (isset($_POST['employer_force_user_id']) && $_POST['employer_force_user_id'] > 0) {
                ...
                $upd_args = array('ID' => $attach_user_id, 'role' => 'jobsearch_employer');
                        ...
                        <div class="jobsearch-table-layer jobsearch-managejobs-tbody">
                            <div class="jobsearch-table-row">
                                <div class="jobsearch-table-cell">
                                    <h6><a href="<?php echo get_permalink($job_id) ?>"><?php echo get_the_title() ?></a>
                                    ...
                                    <ul>
                                        ...
                                        if ($job_publish_date != '') {
                                            ?>
                                            <li>
                                                <i class="jobsearch-icon jobsearch-calendar"></i> <?php printf(wp_kses(__('Created: <span>%s</span>', 'wp-jobsearch'), array('span' => array())), date_i18n('M d, Y', $job_publish_date)) ?>
                                            </li>
                                            <?php
                                        }
                                        if ($job_expiry_date != '') {
                                            ?>
                                            <li>
                                                <i class="jobsearch-icon jobsearch-calendar"></i> <?php printf(wp_kses(__('Expiry: <span>%s</span>', 'wp-jobsearch'), array('span' => array())), date_i18n('M d, Y', $job_expiry_date)) ?>
                                            </li>
                                            <?php
                                        }
                                        if ($get_job_location != '') {
