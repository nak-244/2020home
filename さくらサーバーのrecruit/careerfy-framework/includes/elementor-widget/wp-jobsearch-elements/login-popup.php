...
class LoginPopup extends Widget_Base
{
    ...
    {
        return __('Login Popup Buttons', 'careefy-frame');
    }
    ...
    {
        return [
            'xs' => __('Extra Small', 'careefy-frame'),
            'sm' => __('Small', 'careefy-frame'),
            'md' => __('Medium', 'careefy-frame'),
            'lg' => __('Large', 'careefy-frame'),
            'xl' => __('Extra Large', 'careefy-frame'),
        ];
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            'section_button',
            [
                'label' => __('Login Button Style', 'careefy-frame'),
            ]
        );
        ...
        $this->add_control(
            'button_type',
            [
                'label' => __('Type', 'careefy-frame'),
                'type' => Controls_Manager::SELECT,
                'default' => 'login_only',
                'options' => [
                    'login_only' => __('login Only', 'careefy-frame'),
                    'register_only' => __('Register Only', 'careefy-frame'),
                    'register_login_both' => __('Login and Register', 'careefy-frame'),
                ],
            ]
        );
        ...
        $this->add_control(
            'login_btn_title',
            [
                'label' => __('Login Button Title', 'careefy-frame'),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => __('Login', 'careefy-frame'),
                'placeholder' => __('Login', 'careefy-frame'),
                'condition' => [
                    'button_type' => ['login_only', 'register_login_both'],
                ],
            ]
        );
        ...
        $this->add_control(
            'register_btn_title',
            [
                'label' => __('Register Button Title', 'careefy-frame'),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => __('Register', 'careefy-frame'),
                'placeholder' => __('Register', 'careefy-frame'),
                'condition' => [
                    'button_type' => ['register_only', 'register_login_both'],
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'align',
            [
                'label' => __('Alignment', 'careefy-frame'),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => __('Left', 'careefy-frame'),
                        'icon' => 'eicon-text-align-left',
                    ],
                    'center' => [
                        'title' => __('Center', 'careefy-frame'),
                        'icon' => 'eicon-text-align-center',
                    ],
                    'right' => [
                        'title' => __('Right', 'careefy-frame'),
                        'icon' => 'eicon-text-align-right',
                    ],
                    'justify' => [
                        'title' => __('Justified', 'careefy-frame'),
        ...
        $this->add_control(
            'selected_icon',
            [
                'label' => __('Login Icon', 'careefy-frame'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Register Icon', 'careefy-frame'),
                'type' => Controls_Manager::ICONS,
                'fa4compatibility' => 'icon',
                'condition' => [
                    'button_type' => ['register_only', 'register_login_both'],
        ...
        $this->add_control(
            'icon_align',
            [
                'label' => __('Icon Position', 'careefy-frame'),
                'type' => Controls_Manager::SELECT,
                'default' => 'left',
                'options' => [
                    'left' => __('Before', 'careefy-frame'),
                    'right' => __('After', 'careefy-frame'),
                ],
                'condition' => [
                    'selected_icon[value]!' => '',
                ],
        ...
        $this->add_control(
            'icon_indent',
            [
                'label' => __('Icon Spacing', 'careefy-frame'),
        ...
        $this->add_control(
            'dual_button_gap',
            [
                'label' => __('Button Gap', 'careefy-frame'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 5,
                ],
        ...
        $this->add_control(
            'button_css_id',
            [
                'label' => __('Button ID', 'careefy-frame'),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => '',
                'title' => __('Add your custom id WITHOUT the Pound key. e.g: my-id', 'careefy-frame'),
                'description' => __('Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'careefy-frame'),
                'separator' => 'before',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('My Account Settings', 'careefy-frame'),
        ...
        $this->add_control(
            'account_btn_title',
            [
                'label' => __('Account Link Button Title', 'careefy-frame'),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => __('My Account', 'careefy-frame'),
                'placeholder' => __('My Account', 'careefy-frame'),
            ]
        );
        /*
        ...
        $this->add_control(
            ...
            [
                'label' => __('Profile Username On/Off', 'careefy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'off',
                'options' => [
                    'on' => __('On', 'careefy-frame'),
                    'off' => __('Off', 'careefy-frame'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Profile Image On/Off', 'careefy-frame'),
                'type' => Controls_Manager::SELECT2,
                'default' => 'off',
                'options' => [
                    'on' => __('On', 'careefy-frame'),
        ...
        $this->add_control(
            'image_spacing',
            [
                'label' => __('Image Spacing', 'careefy-frame'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_control(
            'profile_image_width',
            [
                'label' => __('Image Width', 'careefy-frame'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_control(
            'image_border_radius',
            [
                'label' => __('Border Radius', 'careefy-frame'),
        ...
        $this->add_control(
            'button_text_color',
            [
                'label' => __('Text Color', 'careefy-frame'),
        ...
        $this->add_control(
            'background_color',
            [
                'label' => __('Background Color', 'careefy-frame'),
                'type' => Controls_Manager::COLOR,
                'global' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Border Color', 'careefy-frame'),
                'type' => Controls_Manager::COLOR,
                'condition' => [
                    'border_border!' => '',
                ],
        ...
        $this->add_control(
            'hover_animation',
            [
                'label' => __('Hover Animation', 'careefy-frame'),
        ...
        $this->add_responsive_control(
            'text_padding',
            [
                'label' => __('Padding', 'careefy-frame'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Register Button Styles', 'careefy-frame'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    protected function render()
    {
        ...
        <?php } else { ?>
            <?php if ($button_type == 'login_only' || $button_type == 'register_login_both') { ?>
                <a href="javascript:void(0);"
                    <?php echo $this->get_render_attribute_string('button_login'); ?>><?php echo $this->render_text_login() ?></a>
            <?php } ?>
            <?php if ($button_type == 'register_only' || $button_type == 'register_login_both') { ?>
                <a href="javascript:void(0);"
    ...
    { ?>
        ...
        <div class="jobsearch-useraccount-linksbtn">
            <# if(settings.button_type == 'login_only' || settings.button_type == 'register_login_both'){ #>
            ...
            <# if(settings.button_type == 'register_only' || settings.button_type == 'register_login_both'){ #>
            <a id="{{ settings.button_css_id }}"
     ...
     * @access protected
     */
    protected function render_text_my_account($user_displayname)
    {
        global $sitepress;
        $lang_code = '';
    ...
    protected function render_text_login()
    {
        global $sitepress;
        $lang_code = '';
        if (function_exists('icl_object_id') && function_exists('wpml_init_language_switcher')) {
    ...
    protected function render_text_register()
    {
        global $sitepress;
        $lang_code = '';
        if (function_exists('icl_object_id') && function_exists('wpml_init_language_switcher')) {
