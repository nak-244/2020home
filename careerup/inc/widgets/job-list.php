...
class Careerup_Widget_Job_List extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_widget_job_list',
            esc_html__('Apus Simple Jobs List', 'careerup'),
            array( 'description' => esc_html__( 'Show list of job', 'careerup' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('get_jobs_by')); ?>">
                <?php echo esc_html__('Get jobs by:', 'careerup' ); ?>
            </label>
            <br>
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Careerup_Widget_Job_List');
}