	...
	protected function render() {
        ...
        if ( ! is_user_logged_in() ) {
            ...
            <div class="box-list-2">
                <div class="text-warning"><?php  esc_html_e( 'Please login with "Employer" or "Candidate" to see this page.', 'careerup' ); ?></div>
            </div>  
            <?php
        } else {
            $packages = WP_Job_Board_Wc_Paid_Listings_Mixes::get_packages_by_user( get_current_user_id(), false, 'all' );
            if ( !empty($packages) ) {
            ?>
