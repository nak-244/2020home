    ...
    <div class="careerfy-post-item">
        <div class="careerfy-post-wrap">
            ...
            <div class="careerfy-result-text <?php echo sanitize_html_class($no_img_clas) ?>">
                ...
                <?php
                if (careerfy_excerpt(110)) {
                    ?>
                    <p><?php echo careerfy_excerpt(110) ?></p>
                    <?php
                }
                ...
                <div class="post-author">
                 ...
                 -->
                <a href="<?php echo esc_url(get_permalink(get_the_ID())) ?>" class="careerfy-continue-reading">続きを読む <i class="fa fa-angle-right"></i></a>
            </div>
        </div>
    </div>
