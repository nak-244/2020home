            ...
            <div class="jobsearch-candidate-section">
                ...
                if ($user_pkg_limits::cand_field_is_locked('coverltr_defields')) {
                    ...
                    <div class="jobsearch-candidate-dashboard-editor">
                        ...
                        $cover_letter = jobsearch_esc_html($cover_letter);
                                            ...
                                            <li class="jobsearch-column-12 resume-list-item resume-list-edu">
                                                ...
                                                <div class="jobsearch-add-popup jobsearch-update-resume-items-sec">
                                                    ...
                                                    <ul class="jobsearch-row jobsearch-employer-profile-form">
                                                        ...
                                                        <li class="jobsearch-column-4 cand-edu-prsntfield">
                                                            <label><?php esc_html_e('Present', 'wp-jobsearch') ?></label>
                                                            <input class="cand-edu-prsntchkbtn" data-id="<?php echo($rand_num) ?>" type="checkbox" <?php echo($education_prsnt_datefield_val == 'on' ? 'checked' : '') ?>>
                                                            <input name="jobsearch_field_education_date_prsnt[]" type="hidden" value="<?php echo($education_prsnt_datefield_val) ?>">
                                                        </li>
                                                        <li class="jobsearch-column-12">
                                                            <label><?php esc_html_e('Institute *', 'wp-jobsearch') ?></label>
                            ...
                            <div class="jobsearch-add-popup jobsearch-add-resume-item-popup">
                                ...
                                <ul class="jobsearch-row jobsearch-employer-profile-form">
                                    ...
                                    <li class="jobsearch-column-12">
                                        ...
                                        ob_start();
                                        ?>
                                        <label><?php esc_html_e('Experience Description', 'wp-jobsearch') ?></label>
                                        <?php
                                        $title_html = ob_get_clean();
                    ...
                    <div class="jobsearch-candidate-resume-wrap">
                        ...
                        <div class="jobsearch-candidate-title">
                            <h2>
                                ...
                                <a href="javascript:void(0)" class="jobsearch-resume-addbtn"><span class="fa fa-plus"></span> <?php esc_html_e('Add Language', 'wp-jobsearch') ?>
                                </a>
                            </h2>
                        </div>
                            ...
                            <ul class="jobsearch-row jobsearch-employer-profile-form">
                                ...
                                <li class="jobsearch-column-6">
                                    ...
                                    <div class="jobsearch-profile-select">
                                        <select id="add-lang-level" class="selectize-select" placeholder="<?php _e('Speaking Level', 'wp-jobsearch') ?>">
                                            ...
                                            <div class="jobsearch-add-popup jobsearch-update-resume-items-sec">
                                                ...
                                                <ul class="jobsearch-row jobsearch-employer-profile-form">
                                                    ...
                                                    <li class="jobsearch-column-6">
                                                        <label><?php esc_html_e('Level', 'wp-jobsearch') ?></label>
                                                        <div class="jobsearch-profile-select">
                                                            <select name="jobsearch_field_lang_level[]" class="selectize-select" placeholder="<?php _e('Speaking Level', 'wp-jobsearch') ?>">
