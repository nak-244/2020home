                        ...
                        <td align="center" valign="top"><!-- Header -->
                            <table id="template_header" style="background-color: #454545; color: #f1f1f1; -webkit-border-top-left-radius: 6px !important; -webkit-border-top-right-radius: 6px !important; border-top-left-radius: 6px !important; border-top-right-radius: 6px !important; border-bottom: 0; font-family: Arial; font-weight: bold; line-height: 100%; vertical-align: middle;" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h1 id="logo" style="color: #f1f1f1; margin: 0; padding: 28px 24px; display: block; font-family: Arial; font-size: 30px; font-weight: bold; text-align: center; line-height: 150%;">User Shortlisted for Interview</h1>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                        ...
                                        <td id="mailtpl_body_bg" style="background-color: #fafafa;" valign="top"><!-- Content -->
                                            <table border="0" width="100%" cellspacing="0" cellpadding="20">
                                                <tbody>
                                                    <tr>
                                                        <td valign="top">
                                                            <p class="Indented">Dear {candidate_name} ,</p>
                                                            <p class="Indented">Thank you for your application for the above post . I am pleased to inform you that you have been short-listed for interview to {job_title . The interview is likely will be informed by Employer via Telephone or via Email . In the event that you are unable to attend in person, please inform the employer {employer_name} as soon as possible in order that alternative arrangements for your interview may be made (such as Skype).</p>

                                                            <table class="blueTable">
                                                                <thead>
                                                                    <tr>
                                                                        <th style="text-align: center;" colspan="2">User Shortlisted for Interview</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
