...
// Don't duplicate me!
if (!class_exists('ReduxFramework_jobsearch_multi_dashlinks')) {
     ...
     * @since       1.0.0
     */
    class ReduxFramework_jobsearch_multi_dashlinks extends ReduxFramework {
...
// Set default args for this field to avoid bad indexes. Change this to anything you use.
        ...
        public function render() {
            ...
            <div class="jobsearch-socialmultifields-redux">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="icon-appendr">
                                            ...
                                            <a href="javascript:void(0);" class="dashmult-fields-show-icon" data-id="<?php echo ($field_random) ?>" data-name="<?php echo ($option_name) ?>" data-icon="<?php echo ($field_icon) ?>" data-icong="<?php echo ($field_icon_group) ?>"><?php esc_html_e('Select New Icon', 'wp-jobsearch') ?></a>&nbsp;
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="icon-appendr">
                                        ...
                                        <a href="javascript:void(0);" class="dashmult-fields-show-icon" data-id="<?php echo ($field_random) ?>" data-name="<?php echo ($option_name) ?>" data-icon="" data-icong=""><?php esc_html_e('Select New Icon', 'wp-jobsearch') ?></a>&nbsp;
                                        <span class="showicn-loder"></span>
                                    </div>
                                </li>
                            </ul>
                ...
                <div class="add-more-msocilinks-con">
                    <a id="dashmult-fields-addmore" href="javascript:void(0);" data-id="<?php echo ($option_name) ?>" class="multifields-addmore-btn button button-primary"><?php esc_html_e('Add More', 'wp-jobsearch') ?></a>
        ...
        public function enqueue() {
            ...
            $extension = ReduxFramework_extension_jobsearch_multi_dashlinks::getInstance();

            wp_enqueue_script(
                    'jobsearch_multi_dashlinks_script', $this->extension_url . 'field_jobsearch_multi_dashlinks.js', array('jquery'), time(), true
            );
            ...
            wp_localize_script('jobsearch_multi_dashlinks_script', 'jobsearch_multi_dashlinks_vars', $jobsearch_plugin_arr);

            wp_enqueue_style(
                    'jobsearch_multi_dashlinks_styles', $this->extension_url . 'field_jobsearch_multi_dashlinks.css', time(), true
            );
        }
