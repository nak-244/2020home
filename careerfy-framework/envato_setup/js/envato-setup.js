...
var EnvatoWizard = (function($){
    ...
    function window_loaded(){
        ...
        $('.button-next').on( 'click', function(e) {
            var loading_button = webmarce_loading_button(this);
            if(!loading_button){
                return false;
            }
    ...
    function webmarce_loading_button(btn){
        ...
        $button.addClass('webmarce_loading_button_current');
        ...
        return {
                ...
                $button.removeClass('webmarce_loading_button_current');
