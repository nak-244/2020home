...
class JobFeatured extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        $featured_job_num = $atts['featured_job_num'];
        $non_featured_items = $atts['non_featured_items'];
        $job_slide_position = $atts['job_slide_position'];
        $featured_num_slide = $atts['featured_num_slide'];
        $featured_slide_speed = $atts['featured_slide_speed'];
        $featured_section = $atts['featured_section'];
        $slide_execution = $atts['slide_execution'];
                                ...
                                <div class="careerfy-employer-grid-wrap">
                                    ...
                                    <figure>
                                        <?php if ($post_thumbnail_src != '') { ?>
                                            <a href="<?php the_permalink(); ?>" class="careerfy-employer-grid-image"><img src="<?php echo ($post_thumbnail_src) ?>" alt=""></a>
                                        <?php } ?>
                                        <figcaption>
                                            <?php
                ...
                <div id="featured-scroll-<?php echo ($rand_id); ?>">
                    ...
                    if (isset($ids_arr) && !empty($ids_arr) && is_array($ids_arr)) {
                        ...
                        foreach ($ids_arr as $candidate_id) {
                            ...
                            $post_thumbnail_image = wp_get_attachment_image_src($post_thumbnail_id, 'careerfy-candidate-medium');
                            $post_thumbnail_src = isset($post_thumbnail_image[0]) && esc_url($post_thumbnail_image[0]) != '' ? $post_thumbnail_image[0] : jobsearch_candidate_image_placeholder();
                            ...
                            <div>
                                <figure>
                                    ...
                                    <?php if ($post_thumbnail_src != '') { ?>
                                        <a href="<?php the_permalink(); ?>" class="careerfy-candidate-grid-thumb"><img src="<?php echo esc_url($post_thumbnail_src) ?>" alt=""> <span class="careerfy-candidate-grid-status" <?php echo ($final_color) ?>></span></a>
                                    <?php } ?>
                                    <figcaption>
                                        <h2>
                                ...
                                <div class="careerfy-jobs-scroll-slider-wrap">
                                    <figure>
                                        ...
                                        if ($post_thumbnail_src != '') {
                                            ?>
                                            <a href="<?php the_permalink(); ?>"><img src="<?php echo ($post_thumbnail_src) ?>" alt=""></a>
                                            <?php
                                        }
