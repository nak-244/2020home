...
if (isset($featjobs_posts) && !empty($featjobs_posts)) {
 ...
                                        <img src="<?php echo esc_url($post_thumbnail_src) ?>" alt="">
                            ...
                            <div class="careerfy-featured-listing-text">
                                <h2>
                                    <a href="<?php echo esc_url(get_permalink($job_id)); ?>" title="<?php echo get_the_title($job_id); ?>">
                                ...
                                <div class="careerfy-featured-listing-options">
                                    <ul>
                                        ...
                                        if ($job_city_title != '' && $all_location_allow == 'on') {
                                            ?>
                                            <li><i class="careerfy-icon careerfy-maps-and-flags"></i> <?php echo ($job_city_title) ?></li>
                                            <!-- .. -->
                                            <?php
                                        }
...
?>
<div class="careerfy-job-listing careerfy-featured-listing" id="jobsearch-job-<?php echo absint($job_short_counter) ?>">
