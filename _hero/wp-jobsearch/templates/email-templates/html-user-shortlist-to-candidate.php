                        ...
                        <td align="center" valign="top"><!-- Header -->
                            <table id="template_header" style="background-color: #454545; color: #f1f1f1; -webkit-border-top-left-radius: 6px !important; -webkit-border-top-right-radius: 6px !important; border-top-left-radius: 6px !important; border-top-right-radius: 6px !important; border-bottom: 0; font-family: Arial; font-weight: bold; line-height: 100%; vertical-align: middle;" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h1 id="logo" style="color: #f1f1f1; margin: 0; padding: 28px 24px; display: block; font-family: Arial; font-size: 30px; font-weight: bold; text-align: center; line-height: 150%;">User Shortlist to Candidate</h1>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                    ...
                                    <tr>
                                        <td id="mailtpl_body_bg" style="background-color: #fafafa;" valign="top"><!-- Content -->
                                            <table border="0" width="100%" cellspacing="0" cellpadding="20">
                                                <tbody>
                                                    <tr>
                                                        <td valign="top">Dear  {candidate_name} ,
                                                            <p class="Indented">Thank you for your resume that we have on our website {SITE_NAME}   for the above post. I am pleased to inform you that you have been short-listed by Employer : {employer_name}  They can review your C.V as we know you have not applied on any job posted by this employer but they have Instamatch service where they can download any candidate Resume  also they can contact you to give you best opportunity and can SCASUAL interview if they like your Resume. you can find this Employer : {employer_name}  from our website {SITE_URL} ,</p>
                                                            if you do not want to receive this Email please contact site admin at {ADMIN_EMAIL}  .
                                                            <table class="blueTable">
                                                                <thead>
                                                                    <tr>
                                                                        <th style="text-align: center;" colspan="2">user shortlist to candidate</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
