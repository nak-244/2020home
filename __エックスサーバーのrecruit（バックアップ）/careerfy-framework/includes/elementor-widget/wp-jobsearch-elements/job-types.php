 ...
 * @since 1.1.0
 */
class JobTypes extends Widget_Base
{
    ...
    {
        return __('Job Types', 'careerfy-frame');
    }
     ...
     * @access protected
     */
    public function getChildJobTypesJobs($term_sector_slug)
    {
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'num_cats',
            [
                'label' => __('Number of Types', 'careerfy-frame'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} #jobsearch-findby-jobtypes a i' => 'fill: {{VALUE}}; color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
    ...
    function render()
    {
        ...
        if (class_exists('JobSearch_plugin')) {
            ...
            ?>
            <div id="jobsearch-findby-jobtypes" class="<?php echo($cats_class) ?>"
                 data-view="<?php echo($cats_view) ?>">
