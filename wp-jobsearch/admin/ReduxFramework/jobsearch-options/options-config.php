    ...
    class Redux_Framework_options_config
    {
        ...
        public function setSections() {
            ...
            $api_fields_sec[] = array(
                ...
                'desc' => '',
                'subtitle' => __('Put your MapBox Access Token here.', 'wp-jobsearch'),
                'default' => ''
            );
...
Your membership account is awaiting approval by the site administrator. You will not be able to fully interact with the account functions and aspects of this website until your account is approved. Once approved by admin or denied you will receive an email notice.',
            ...
            $employer_details_arr[] = array(
                ...
                'desc' => '',
                'subtitle' => __('Allow candidates to contact the employer at the Employers detail page.', 'wp-jobsearch'),
                'options' => array(
                    'on' => __('On', 'wp-jobsearch'),
                    'off' => __('Off', 'wp-jobsearch'),
                ),
            ...
            $employer_details_arr[] = array(
                ...
                'desc' => '',
                'subtitle' => __('Allow users to contact employers without login.', 'wp-jobsearch'),
                'options' => array(
                    'on' => __('Yes', 'wp-jobsearch'),
                    'off' => __('No', 'wp-jobsearch'),
                ),
            ...
            $job_detail_settins[] = array(
                ...
                'subtitle' => __('Allow candidates to contact the employer at the job detail page.', 'wp-jobsearch'),
                'desc' => '',
                'options' => array(
                    'on' => __('On', 'wp-jobsearch'),
                    'off' => __('Off', 'wp-jobsearch'),
            ...
            $job_detail_settins[] = array(
                ...
                'type' => 'media',
                'url' => true,
                'title' => __('Notification Image', 'wp-josearch'),
                'compiler' => 'true',
            ...
            $job_detail_settins[] = array(
                ...
                'type' => 'media',
                'url' => true,
                'title' => __('Notification Logo', 'wp-josearch'),
                'compiler' => 'true',
